...
const summaryObj = {
    ...
    "skill": ["amet consectetur adipisicing elit. Ipsum explicabo harum quams neque, sed eleifend ", "Quisque tincidunt luctus mollis. Donec pellentesque vel neque molestie cursus. Mauris lobortis turpis quam, sed finibus"],
    "education": ["The Vestibulum vulputate, ante eu suscipit scelerisque, nunc urna tincidunt leo, ut vehicula turpis urna auctor neque. Morbi iaculis lorem ut libero cursus facilisis.", "Tonec pellentesque vel neque molestie cursus"],
...
const Homepage = () => {
    return (
        <StyledMain>
            ...
            <Styledfooter>
                <Footer email={'testmail@mailer.com'}/>
            </Styledfooter>
        </StyledMain>
